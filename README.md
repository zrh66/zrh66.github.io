...
> 2018年初终于基于GitHub Pages搭出了这个blog站点，即使只是fork+modify :) 偶然看见这个jekyll模板很好看顺藤摸瓜找到qiubaiying，找到Hux，也算一步步迭代到现在这样，不得不感叹做前端的到底是做前端的，既然设计不如人家干嘛还要花时间自己设计呢，直接拿来用好了哈哈。（为什么如此心安理得0.0）（手动滑稽）
>
> 索性...连README.MD也直接用柏荧的好了哈哈哈
>
...
> 
### [柏荧的博客在这里 &rarr;](http://qiubaiying.github.io)
